        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Mesin Chopper</h4>
                </div>
                <form action="{{ url('/admin/chopper/store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="d-flex justify-content-center">
                        <div class="input-form container pb-2 m-3">
                            ...
                            <div class="d-flex pt-3">
                                <a href="{{ url('/admin/chopper/') }}" class="btn btn-secondary btn-sm justify-content-start me-2"><i class="fa-solid fa-arrow-left"></i> Back</a>
